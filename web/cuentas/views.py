...
def dashboard_artesano(request):
    if not request.user.perfil.es_artesano():
        messages.error(request, "No tienes permiso para acceder aqui.")
        return redirect("Home")
...
def producto_crear(request):
    ...
    return render(
        ...
        {"form": form, "titulo": "Nuevo Producto", "boton": "Publicar producto"},
    )
...
def producto_eliminar(request, producto_id):
    ...
    return render(request, "cuentas/producto_confirmar_eliminar.html", {"producto": producto})
